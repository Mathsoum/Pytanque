...
class ContestWidget(QWidget):
    ...
    def setup_third_match_view(self):
        ...
        third_match_no_win_label = QLabel("(0/2)")
        third_match_no_win_label.setAlignment(Qt.AlignCenter)
        third_match_one_win_label = QLabel("(1/1)")
        third_match_one_win_label.setAlignment(Qt.AlignCenter)
        third_match_two_win_label = QLabel("(2/0)")
        third_match_two_win_label.setAlignment(Qt.AlignCenter)
        self.third_match_no_win_table_view = QTableView()
        self.third_match_one_win_table_view = QTableView()
        self.third_match_two_win_table_view = QTableView()
        self.setup_view(self.contest_model.third_match_no_win_model, self.third_match_no_win_table_view)
        self.setup_view(self.contest_model.third_match_one_win_model, self.third_match_one_win_table_view)
        self.setup_view(self.contest_model.third_match_two_win_model, self.third_match_two_win_table_view)
        third_match_layout = QVBoxLayout()
        third_match_layout.addWidget(third_match_label)
        third_match_layout.addWidget(third_match_two_win_label)
        third_match_layout.addWidget(self.third_match_two_win_table_view)
        third_match_layout.addWidget(third_match_one_win_label)
        third_match_layout.addWidget(self.third_match_one_win_table_view)
        third_match_layout.addWidget(third_match_no_win_label)
    ...
    def setup_forth_match_view(self):
        ...
        fourth_match_no_win_label = QLabel("(0/3)")
        fourth_match_no_win_label.setAlignment(Qt.AlignCenter)
        fourth_match_one_win_label = QLabel("(1/2)")
        fourth_match_one_win_label.setAlignment(Qt.AlignCenter)
        fourth_match_two_win_label = QLabel("(2/1)")
        fourth_match_two_win_label.setAlignment(Qt.AlignCenter)
        fourth_match_three_win_label = QLabel("(3/0)")
        fourth_match_three_win_label.setAlignment(Qt.AlignCenter)
        self.fourth_match_no_win_table_view = QTableView()
        self.fourth_match_one_win_table_view = QTableView()
        self.fourth_match_two_win_table_view = QTableView()
        self.fourth_match_three_win_table_view = QTableView()
        self.setup_view(self.contest_model.fourth_match_no_win_model, self.fourth_match_no_win_table_view)
        self.setup_view(self.contest_model.fourth_match_one_win_model, self.fourth_match_one_win_table_view)
        self.setup_view(self.contest_model.fourth_match_two_win_model, self.fourth_match_two_win_table_view)
        self.setup_view(self.contest_model.fourth_match_three_win_model, self.fourth_match_three_win_table_view)
        fourth_match_layout = QVBoxLayout()
        fourth_match_layout.addWidget(fourth_match_label)
        fourth_match_layout.addWidget(fourth_match_three_win_label)
        fourth_match_layout.addWidget(self.fourth_match_three_win_table_view)
        fourth_match_layout.addWidget(fourth_match_two_win_label)
        fourth_match_layout.addWidget(self.fourth_match_two_win_table_view)
        fourth_match_layout.addWidget(fourth_match_one_win_label)
        fourth_match_layout.addWidget(self.fourth_match_one_win_table_view)
        fourth_match_layout.addWidget(fourth_match_no_win_label)
